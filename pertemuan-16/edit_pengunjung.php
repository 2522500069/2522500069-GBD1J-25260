<?php
  ...
  */
  $stmt = mysqli_prepare($conn, "SELECT cid, ckode, cnamat, calamat,	ctanggal,chobi,	casal,	cpekerjaan,	cnama_orang_tua,	cnama_pacar,	cnama_mantan	
        ...
        <form action="proses_update_biodata.php" method="POST">
          ...
          <label for="txtkode"><span>NIM:</span>
            <input type="text" id="txtkode" name="txtkode" 
              placeholder="Masukkan kode" required autocomplete="nim"
              value="<?= !empty($kode) ? $kode : '' ?>">
          </label>

          <label for="txtNma"><span>Nama pengunjung:</span>
            <input type="text" id="txtNmpengunjung" name="txtNmpengunjung" 
              placeholder="Masukkan nama pengunjung anda" required autocomplete="nama"
              value="<?= !empty($nama) ? $nama : '' ?>">
          </label>
          <label for="txtalamat"><span>alamat rumah:</span>
            <input type="text" id="txtalamat rumah" name="txt" 
              placeholder="Masukkan alamat rumah" required autocomplete="alamat"
          ...
          <label for="txtTglkunjungan"><span>Tanggal kunjungan:</span>
            <input type="text" id="txtTglLhr" name="txtTglLhr" 
              placeholder="Masukkan tanggal kunjungan" required autocomplete="tanggal"
